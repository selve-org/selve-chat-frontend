...
const PLACEHOLDER_QUESTIONS = [
  ...
  'What personality trait is secretly sabotaging my success?',
  'Why do I push people away even when I want connection?',
  'What blind spot do my friends see that I don\'t?',
  'If you analyzed my communication style, what does it say about me?',
  'What type of person am I becoming?',
  'Based on my answers, what emotional pattern do I repeat the most?',
  'Am I driven more by fear, validation, or ambition?',
  'What situations trigger my worst behavior?',
  'What childhood coping mechanism am I still using as an adult?',
  'What does my stress response reveal about my personality?',
  'What kind of partner am I naturally compatible with?',
  'Why do my relationships follow the same pattern?',
  'How do I handle conflict compared to most people?',
  'Do I love deeply or defensively?',
  'What attachment style do I show based on my behavior?',
  'What career environment would drain me vs energize me?',
  'Am I more visionary or executor?',
  'Would I thrive as a founder or under structure?',
  'What\'s my hidden leadership strength?',
  'Why do I procrastinate when things matter most?',
  'What\'s my biggest internal contradiction?',
  'What do I pretend not to care about, but actually deeply care about?',
  'If someone dated me, what would frustrate them the most?',
  'What personality type would misunderstand me?',
  'What emotion do I suppress the most?',
  'How do my friends describe me vs how I describe myself?',
  'Where do others see strengths I ignore?',
  'What personality mismatch exists between my self-image and external image?',
  'Based on how I communicate, what do you think I’m most insecure about...but rarely admit?'
]
